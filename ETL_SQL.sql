...
SELECT happy_data.overall_rank, happy_data.country, happy_data.score, happy_data.gdp_per_capita, happy_data.social_support, happy_data.healthy_life_expectancy, govt_data.units, govt_data."2019"
FROM happy_data
JOIN govt_data
